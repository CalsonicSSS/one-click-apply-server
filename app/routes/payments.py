...
async def payment_success(browser_id: str):
    ...
    <head>
        ...
        <title>Payment Successful | One-Click Apply</title>
        <style>
            body {{
    ...
    <body>
        <div class="container">
            ...
            <p>You can close this window and return to One-Click Apply to continue applying your perfect job application.</p>
            <button class="button" onclick="window.close()">Close Window</button>
        </div>
        <script>
            // This script communicates with the One-Click Apply extension
            function notifyExtension() {{
                // Your actual extension ID (NOT the browser_id)
                const EXTENSION_ID = "hlledknjllldafnfhnohjkdhjciminid";
...
async def payment_cancel():
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Payment Cancelled | One-Click Apply</title>
        <style>
            body {

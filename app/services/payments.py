...
async def create_checkout_session(browser_id: str, package: str) -> dict:
    ...
    try:
        success_url = f"https://one-click-apply-server.onrender.com/api/v1/payments/success?browser_id={browser_id}"
        cancel_url = f"https://one-click-apply-server.onrender.com/api/v1/payments/cancel"
        ...
        session = stripe.checkout.Session.create(
            ...
            metadata={"browser_id": browser_id, "package": package, "credits": str(package_info["credits"])},
        )
